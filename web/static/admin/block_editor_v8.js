(function () {
  ...
  const BLOCK_TYPES = [
    ...
    { value: "bs_accordion", label: "Accordion", icon: "AC", group: "Bootstrap Components", hidden: true },
    { value: "bs_tabs", label: "Tabs", icon: "TS", group: "Bootstrap Components", hidden: true },
    ...
    { value: "bs_collapse", label: "Collapse", icon: "CL", group: "Bootstrap Components", hidden: true },
    { value: "bs_spinner", label: "Spinner", icon: "SP", group: "Bootstrap Components" },
    { value: "bs_carousel", label: "Carousel", icon: "CR", group: "Bootstrap Components", hidden: true },
    { value: "bs_nav", label: "Nav", icon: "NV", group: "Bootstrap Components" },
    { value: "bs_modal", label: "Modal", icon: "MO", group: "Bootstrap Components", hidden: true },
    { value: "bs_toast", label: "Toast", icon: "TO", group: "Bootstrap Components", hidden: true },
    { value: "bs_offcanvas", label: "Offcanvas", icon: "OF", group: "Bootstrap Components", hidden: true },
    { value: "bs_dropdown", label: "Dropdown", icon: "DD", group: "Bootstrap Components", hidden: true },
    { value: "bs_navbar", label: "Navbar", icon: "NB", group: "Bootstrap Components", hidden: true },
    { value: "bs_close_button", label: "Close Button", icon: "CB", group: "Bootstrap Components" },
    { value: "bs_tooltip", label: "Tooltip", icon: "TT", group: "Bootstrap Components", hidden: true },
    { value: "bs_popover", label: "Popover", icon: "PO", group: "Bootstrap Components", hidden: true },
    { value: "bs_scrollspy", label: "Scrollspy", icon: "SS", group: "Bootstrap Components", hidden: true },
