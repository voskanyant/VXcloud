(function () {
  ...
  const BLOCK_TYPES = [
    ...
    { value: "bs_alert", label: "Bootstrap Alert", icon: "AL", group: "Bootstrap" },
    { value: "bs_badge", label: "Bootstrap Badge", icon: "BD", group: "Bootstrap" },
    { value: "bs_card", label: "Bootstrap Card", icon: "CD", group: "Bootstrap" },
    { value: "bs_accordion", label: "Bootstrap Accordion", icon: "AC", group: "Bootstrap" },
    { value: "bs_tabs", label: "Bootstrap Tabs", icon: "TB", group: "Bootstrap" },
    { value: "bs_table", label: "Bootstrap Table", icon: "TR", group: "Bootstrap" },
    { value: "bs_list_group", label: "Bootstrap List Group", icon: "LG", group: "Bootstrap" },
    { value: "bs_progress", label: "Bootstrap Progress", icon: "PR", group: "Bootstrap" },
    { value: "bs_breadcrumb", label: "Bootstrap Breadcrumb", icon: "BR", group: "Bootstrap" },
    { value: "bs_pagination", label: "Bootstrap Pagination", icon: "PG", group: "Bootstrap" },
    { value: "bs_collapse", label: "Bootstrap Collapse", icon: "CP", group: "Bootstrap" },
  ...
  const GROUPS = ["Text", "Media", "Design", "Bootstrap", "Layout", "Advanced"];
          ...
          columns = row.columns
            .map((col) => {
              ...
              return {
                ...
                blocks: blocks.length ? blocks : [{ type: "paragraph", text: "Column text" }],
              };
            })
            .filter(Boolean);
        }
    ...
    switch (type) {
      ...
      case "bs_alert":
        return {
          ...
          variant: "info",
          title: "Важно",
          text: "Текст уведомления для пользователя.",
        };
      case "bs_badge":
        return {
          type,
      ...
      case "bs_accordion":
        return {
          ...
          flush: false,
          items: [
            { title: "Вопрос 1", text: "Ответ на первый вопрос." },
            { title: "Вопрос 2", text: "Ответ на второй вопрос." },
          ],
        };
      case "bs_tabs":
        return {
          ...
          style: "tabs",
          items: [
            { title: "iOS", text: "Инструкция для iOS." },
            { title: "Android", text: "Инструкция для Android." },
          ],
        };
      case "bs_table":
        return {
          type,
          headers: ["Тариф", "Срок", "Цена"],
          rows: [
            ["Базовый", "30 дней", "10 Stars"],
            ["Расширенный", "90 дней", "27 Stars"],
          ],
          striped: true,
          hover: true,
          bordered: false,
      ...
      case "bs_breadcrumb":
        return {
          ...
          items: [
            ...
            { label: "Инструкции", url: "/guides/", active: false },
            { label: "Текущая страница", url: "", active: true },
          ],
        };
      case "bs_pagination":
        return {
          ...
          align: "start",
          items: [
            { label: "Назад", url: "#", disabled: true },
            { label: "1", url: "#", active: true },
            { label: "2", url: "#", active: false },
            { label: "3", url: "#", active: false },
            { label: "Вперёд", url: "#", active: false },
          ],
        };
      case "bs_collapse":
        return {
          type,
          button_text: "Показать подробности",
          text: "Скрытый контент для дополнительных инструкций.",
          variant: "primary",
          open: false,
        };
      case "bs_spinner":
          ...
          items: [
            {
              ...
              title: "Шаг 1",
              caption: "Оформите подписку.",
              alt: "Шаг 1",
            },
            {
              image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80",
              title: "Шаг 2",
              caption: "Получите конфиг.",
              alt: "Шаг 2",
            },
          ],
        };
  ...
  function mountEditor(source) {
    ...
    function renderInspector() {
      ...
      function defaultRowColumn() {
        return { width: 6, blocks: [{ type: "paragraph", text: "Column text" }] };
      }
