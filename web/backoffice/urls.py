...
urlpatterns = [
    ...
    path("infra/edges/", views.EdgeServerListView.as_view(), name="edge_server_list"),
    path("infra/edges/new/", views.EdgeServerCreateView.as_view(), name="edge_server_create"),
    path("infra/edges/<int:pk>/edit/", views.EdgeServerUpdateView.as_view(), name="edge_server_update"),
    path("infra/edges/<int:pk>/delete/", views.EdgeServerDeleteView.as_view(), name="edge_server_delete"),
