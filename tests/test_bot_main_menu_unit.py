...
class BotMainMenuUnitTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_send_config_actions_are_mini_app_first(self):
        ...
        markup = message.replies[-1][1]
        self.assertEqual(markup.inline_keyboard[0][0].text, "\U0001f517 \u0421\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0441\u0441\u044b\u043b\u043a\u0443")
        self.assertEqual(
            markup.inline_keyboard[0][0].api_kwargs["copy_text"]["text"],
            "https://vxcloud.ru/account/feed/token/",
        )
        self.assertEqual(markup.inline_keyboard[1][0].text, "⚡ V2Box авто")
        self.assertIn("https://vxcloud.ru/open-app/?u=v2box", markup.inline_keyboard[1][0].url)
        self.assertIn("install-config", markup.inline_keyboard[1][0].url)
        self.assertEqual(markup.inline_keyboard[2][0].text, "📱 Другие приложения")
    ...
    async def test_send_config_fallback_connection_link_label_is_russian(self):
        ...
        self.assertIn("\u0421\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0441\u0441\u044b\u043b\u043a\u0443", message.replies[-1][1].inline_keyboard[0][0].text)
    ...
    async def test_expired_config_card_puts_renewal_first(self):
        ...
        self.assertEqual(markup.inline_keyboard[2][0].text, "⚡ V2Box авто")
        self.assertIn("https://vxcloud.ru/open-app/?u=v2box", markup.inline_keyboard[2][0].url)
        self.assertEqual(markup.inline_keyboard[3][0].text, "📱 Другие приложения")
        self.assertEqual(markup.inline_keyboard[3][0].web_app.url, "https://vxcloud.ru/account-app/install/42/?embed=1")
        self.assertEqual(markup.inline_keyboard[4][0].text, "📱 Открыть доступ")
        self.assertEqual(markup.inline_keyboard[4][0].web_app.url, "https://vxcloud.ru/account-app/config/42/?embed=1")
        self.assertEqual(markup.inline_keyboard[4][1].text, "QR")
        self.assertEqual(markup.inline_keyboard[4][1].callback_data, "act|cfg_qr:42|_")
        self.assertEqual(markup.inline_keyboard[5][1].callback_data, "act|cfg_delete_request:42|_")
        self.assertEqual(markup.inline_keyboard[6][0].text, "Назад")
        self.assertEqual(markup.inline_keyboard[6][0].callback_data, "act|cfg_back|_")
        self.assertEqual(len(markup.inline_keyboard), 7)
    ...
    async def test_qr_action_uses_subscription_feed_url_not_raw_vless(self):
        ...
        self.assertEqual(query.message.photos[0][2].inline_keyboard[0][0].text, "🔗 Скопировать ссылку")
        self.assertEqual(query.message.photos[0][2].inline_keyboard[1][0].text, "⚡ V2Box авто")
        self.assertEqual(query.message.photos[0][2].inline_keyboard[2][0].text, "📱 Другие приложения")
        self.assertEqual(query.message.photos[0][2].inline_keyboard[3][0].text, "📱 Открыть доступ")
