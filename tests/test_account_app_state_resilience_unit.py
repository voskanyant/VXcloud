...
class AccountAppStateResilienceUnitTests(unittest.TestCase):
    ...
    def test_open_app_auto_import_preserves_nested_encoded_url(self):
        ...
        self.assertIn("нажмите нужное приложение еще раз", html)
        self.assertIn("canAutoRun", html)
        self.assertIn("isIosBrowser", html)
        self.assertIn("В Safari iPhone нельзя тихо проверить", html)
        self.assertIn("v2box://", html)
