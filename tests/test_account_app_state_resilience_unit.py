...
class AccountAppStateResilienceUnitTests(unittest.TestCase):
    ...
    def test_account_app_dashboard_active_user_gets_access_first(self):
        ...
        self.assertIn("js-smart-import", actions_html)
        self.assertIn('data-first-import-url="streisand://import/http://testserver/account/feed/feed-token/#VXcloud"', actions_html)
    ...
    def test_account_app_install_detects_device_and_lists_requested_apps(self):
        ...
        self.assertIn("js-smart-import", html)
        self.assertIn('data-first-import-url="streisand://import/http://testserver/account/feed/feed-token/#VXcloud"', html)
