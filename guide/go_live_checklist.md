...
- копируется стабильная ссылка подписки `https://vxcloud.ru/account/feed/<token>/`
- не показываем raw `vless://...` как основной пользовательский артефакт
- QR-код соответствует той же ссылке подписки
